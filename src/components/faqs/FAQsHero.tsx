...
export function FAQsHero({ onSearch }: FAQsHeroProps) {
    ...
    <section className="relative pt-32 pb-16 px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-xl text-gray-400 mb-10">
          Get quick answers to the most common questions about Quant, pricing, backtesting,
          strategies, and trading automation.
        </p>
        ...
        <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#0A0A0A] border border-white/10 rounded-xl pl-12 pr-4 py-4 text-white placeholder:text-gray-500 focus:outline-none focus:border-[#00FF88]/50 transition-colors"
            />
          </div>
        </form>
      </div>
