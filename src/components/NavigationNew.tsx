...
export function Navigation() {
  ...
  const handleNavigation = (page: "home" | "about" | "features" | "pricing" | "contact") => {
  ...
  const resourcesItems = [
    ...
    { name: "API Docs", href: "#api-docs", description: "Developer documentation" },
    { name: "Release Notes", href: "#release-notes", description: "What's new in Quant" },
    { name: "Roadmap", href: "#roadmap", description: "Our product vision" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:block">
            <Button className="bg-gradient-to-r from-[#00FF88] to-[#00C8FF] text-black hover:opacity-90 hover:scale-105 transition-all shadow-lg shadow-[#00FF88]/20">
              Sign Up
            </Button>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden py-4 border-t border-white/10">
            <div className="flex flex-col gap-4">
              ...
              <Button className="bg-gradient-to-r from-[#00FF88] to-[#00C8FF] text-black hover:opacity-90 transition-opacity w-full">
                Sign Up
              </Button>
            </div>
          </div>
